...
- Multi-theme systems (data-theme="blue" | "green" | etc.) - not supported
- Dynamic theme switching beyond light/dark - not supported
...
```typescript
// Preferred: Vite Plugin - one line, no PostCSS config
import tailwindcss from "@tailwindcss/vite";
...
// Avoid: PostCSS - multiple steps, plugin compatibility issues
