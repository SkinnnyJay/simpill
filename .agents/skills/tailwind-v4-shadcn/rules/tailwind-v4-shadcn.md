...
```css
/* Avoid: v3 (Claude may suggest this) */
@tailwind base;
@tailwind components;
@tailwind utilities;
...
```bash
# Avoid: v3 package (deprecated for v4)
...
```css
/* Avoid: v3 - require() in config */
plugins: [require("@tailwindcss/typography")] /* Use: v4 - @plugin directive in CSS */ @plugin
