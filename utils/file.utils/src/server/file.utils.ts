...
/**
 * Read file and parse as JSON. T is not runtime-validated; validate at call site (e.g. Zod) when shape matters.
 */
...
/** Sync read and parse JSON; T not validated at runtime. */
export function readFileJsonSync<T = unknown>(path: string): T {
