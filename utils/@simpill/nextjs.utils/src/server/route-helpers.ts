...
export function jsonResponse(data: unknown, status = HTTP_STATUS_OK, init?: ResponseInit): Response {
...
export function errorResponse(err: unknown, status = HTTP_STATUS_INTERNAL_SERVER_ERROR, init?: ResponseInit): Response {
  const payload =
